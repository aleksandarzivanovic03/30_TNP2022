...
\begin{table}[h!]
    ...
    \hline
   \centering{\textbf{Vladavina}}    & \centering{\textbf{Ekonomija}} & \centering{\textbf{Mobilnost}} & \centering{\textbf{Okruženje}} & \centering{\textbf{Ljudi}} & \textbf{Život} \\
   \hline
    ...
    \caption{Izazovi pametnog grada u evropskim gradovima.}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{4cm}|p{4cm}|p{4cm}|p{4cm}|p{4cm}|p{4cm}|}
    \hline
   \centering{\textbf{Pametna pokretnost}}    & \centering{\textbf{Pametna ekonomija}} & \centering{\textbf{Pametna vladavina}} & \centering{\textbf{Pametan život}} & \centering{\textbf{Pametni ljudi}} & \textbf{Pametno okruženje} \\
   \hline
     Multimodalnost & Fleksibilnost slobode marketa & Vladavina na više nivoa & Upravljanje javnim mestima & Inkluzivno društvo & Zaštita okoline\\
    \hline
    Čiste, nemotorizovane opcije & Produktivnost & Javne i društvene usluge & Blagostanja i inkluzivno društvo & Stvaranje zajednica i rukovođenje gradskim životom & Upravljanje resursima\\
    \hline
    Pristupačnost & Lokalna i globalna povezanost & Transparentnost i pristupačnost informacija & Pristupačnost tehnologiji & ICT - omogućen rad & Pametno renoviranje i pametne zgrade\\
    \hline 
    Logistika & Preduzetništvo & Učestvovanje & Bezbednost & Kreativnost & Efikasnost energije\\
    \hline 
      ICT infratruktura & Inovacija &  & Briga o zdravlju & Digitalna pismenost & Urbano planiranje i renoviranje\\
     \hline
      Javni prevoz & & & Kultura i turizam &  & Monitoring i mreža životne sredine\\
      \hline 
...
\begin{figure}[h!]
    ...
    \caption{Komponente pametnog grada}
    \label{fig:slika}
\end{figure}
